...
curl -v -u starkandwayne:starkandwayne localhost:3000/v2/service_instances/${instance_id} \
   ...
   -d '{"service_id": "beb5973c-e1b2-11e5-a736-c7c0b526363d", "plan_id": "b96d0936-e423-11e5-accb-93d374e93368", "organization_guid": "unknown", "space_guid": "unknown", "parameters": {"node-count": 1}}'
set +x
